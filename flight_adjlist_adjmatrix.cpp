...
// be the time that flight take to reach city B from A, or the amount of fuel used
// for the journey. Represent this as a graph. The node can be represented by airport
